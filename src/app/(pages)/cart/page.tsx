...
const page = () => {
  return (
    <div className="h-full w-screen flex flex-col md:flex-row relative">
      ...
      <div className="total lg:flex-grow-[1] lg:p-[300px] md:flex flex-col md:justify-center flex-1 bg-red-300 w-full py-10 px-5 ">
